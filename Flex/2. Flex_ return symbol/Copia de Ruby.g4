...
function_name : id_function | id | ID DOT ID_FUNCTION;
...
function_call : (function_name) (LEFT_RBRACKET function_call_param_list RIGHT_RBRACKET |function_call_param_list | LEFT_RBRACKET RIGHT_RBRACKET);
